...
############
# Get all suspended virtual machines from all users
#
# This script will get all suspended virtual machines from all users
#
...
#
# This will get all suspended machines and format the output as a csv
############
